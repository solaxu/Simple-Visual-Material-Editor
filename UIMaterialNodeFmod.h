...
{
	class UINodeFmod : public SUIWindow
	{
	public:
		UINodeFmod(float x, float y, float width, float heigth, UIObject* parent)
			: SUIWindow(x, y, width, heigth, UIDrawParams::DefaultBorderWidth, parent)
		{
			...
			m_nodeType->Name = CString(_T("Fmod"));
