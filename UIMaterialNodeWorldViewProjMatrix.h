...
{
	class UINodeWorldViewProjMatrix : public SUIWindow
	{
	public:
		UINodeWorldViewProjMatrix(float x, float y, float width, float heigth, UIObject* parent)
			: SUIWindow(x, y, width, heigth, UIDrawParams::DefaultBorderWidth, parent)
		{
			...
			m_nodeType->Name = CString(_T("WVP Mat4"));
		...
		virtual ~UINodeWorldViewProjMatrix()
		{
